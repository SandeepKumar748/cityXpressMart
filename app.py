...
my_client = pymongo.MongoClient("mongodb+srv://lahari:tXNP7SS2hfM697s@cityexpressmart-db.qeqk9ns.mongodb.net/?retryWrites=true&w=majority&appName=CityExpressMart-db")
my_db = my_client.get_database("CityXpressMart-db")
app = Flask(__name__)
app.secret_key = "cxpm"
...
if __name__ == '__main__':
    # Get the port from the PORT environment variable or use 5000 as a default
